...
echo -e "\e[1;92m            F . V I R U S\e[0m"
echo -e "\e[1;92m--------------------------------------------------\e[0m"
echo -e "\e[1;77m These tool coded by Tanzania hacker Mr.Virus\e[0m"
echo -e "\e[1;77m Any problem visit Instagram: \e[1;92m@uknown_virus404x\e[0m"
echo -e "\e[1;92m--------------------------------------------------\e[0m"
echo
}
printf "\n"
